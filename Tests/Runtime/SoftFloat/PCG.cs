namespace GameLibrary.Mathematics.Tests
{
    ...
    public struct PCG
    {
        ...
        public SoftFloat SFloatInclusive(SoftFloat minInclusive, SoftFloat maxInclusive)
        {
            SoftFloat diff = maxInclusive - minInclusive;
            SoftFloat rand = (SoftFloat)Uint32(16777216) / SoftFloat.FromRaw(0x4b7fffff);
            return diff * rand + minInclusive;
        }

        public SoftFloat SFloatExclusive(SoftFloat minInclusive, SoftFloat maxExclusive)
        {
            SoftFloat diff = maxExclusive - minInclusive;
            SoftFloat rand = (SoftFloat)Uint32(16777216) / SoftFloat.FromRaw(0x4b800000);
            return diff * rand + minInclusive;
        }
    }
}